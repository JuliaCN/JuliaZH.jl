...
## [Julia 与其他语言的比较](@id man-julia-compared-other-languages)

Julia 拥有可选类型标注和多重派发这两个特性，同时还拥有很棒的性能。
这些都得归功于使用 [LLVM](https://discourse.juliacn.com/t/topic/4203#llvm) 实现的类型推导和[即时编译（JIT）](https://discourse.juliacn.com/t/topic/4203#just-in-time-compilation)技术 (和
[可选的提前编译（AOT）](https://github.com/JuliaLang/PackageCompiler.jl))。
Julia 是一门支持过程式、函数式和面向对象的多范式语言。
...
### [是什么让 Julia 成为 Julia？](@id man-what-makes-julia)
...
### [Julia 的优势](@id man-advantages-of-julia)
